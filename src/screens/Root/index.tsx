...
import {Footer, Header, Left, Right, Text, Body, Container} from "native-base";
                                        ...
                                        <TouchableOpacity>
                                            <View style={{
                                                ...
                                                <Text style={{fontSize: 14, color: colors.white}}>LAST
                                                    24 HOURS</Text>
                                                <Icon style={{color: colors.white,fontSize:28}}
                                                      name='chevron-down'/>
                                            </View>
                                        </TouchableOpacity>
                                    </Left>
                ...
                <VerticalSwipe
                    ...
                    <RNCamera
                        ...
                        <Header rounded searchBar style={styles.headerCamera}>
                            <Left>
                                <TouchableOpacity>
                                    <Icon style={{color: colors.white,fontSize:32}}
                                          name='cog'/>
                                </TouchableOpacity>
                            </Left>
                            <Body>
                        ...
                        <View style={styles.bottomOverlay}>
                            ...
                            <Footer style={styles.footerCamera}>
                                ...
                                <Right style={{flex: 4}}>
                                    <TouchableOpacity>
                                        <Icon style={{width: 39,fontSize:54, height: 39, color: colors.white}}
                                              name='camera-retake'/>
                                    </TouchableOpacity>
                                </Right>
