...
export default class StoriesData extends PureComponent {
    ...
    constructor(props: any) {
        super(props);
        const _stories = props.dataStory.medias;
    ...
    render() {
        const {x} = this.state;
        // @ts-ignore
        const {footerComponent, dataStory} = this.props;

        return (
            <View style={styles.container}>
                {this.props.dataStory.medias
                    .map((story: any, i: any) => (
                        <Animated.View
                            ref={this.stories[i]}
                        ...
                        >
                            <SlideItem
                                footerComponent={footerComponent} user={dataStory.visiteur.prenom}
                                image={dataStory.visiteur.photo}
                                {...{story}}
                            />
                        </Animated.View>
                    ))
                ...
                <Animated.ScrollView
                    ...
                    contentContainerStyle={{width: width * this.props.dataStory.medias.length}}
